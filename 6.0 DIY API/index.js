...
app.get("/jokes/:id", (req, res) => {
	var idSelect = parseInt(req.params.id);
	var joke = jokes.find((j) => j.id === idSelect);
	res.json(joke);
});
...
app.patch("/jokes/:id", (req, res) => {
	...
	if (data.type !== undefined) {
		joke.jokeType = data.type;
	}
	if (data.text !== undefined) {
		joke.jokeText = data.text;
	}
	console.log(joke);
	jokes[id - 1] = joke;
	res.sendStatus(200);
...
app.delete("/jokes/:id", (req, res) => {
	...
	console.log(jokes.splice(id - 1, 1));
	res.sendStatus(200);
});
//8. DELETE All jokes
app.delete("/all", (req, res) => {
	...
	if (req.query.key === masterKey) {
		...
		res.sendStatus(400).send("Invalid key");
	}
});
app.listen(port, () => {
